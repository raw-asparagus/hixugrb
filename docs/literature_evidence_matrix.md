...
| # | Claim in `.md` | Paper (Appendix B1) | Pipeline (Pinetti 2022) | Status |
|---|----------------|---------------------|-------------------------|--------|
...
| # | Claim in `.md` | Paper (Table 3, α=2) | Pipeline (Pinetti 2022) | Status |
|---|----------------|----------------------|-------------------------|--------|
...
| # | Claim in `.md` | Paper | Pipeline (Pinetti 2022) | Status |
|---|----------------|-------|-------------------------|--------|
| 3.1 | ν f(ν) = A[1+(qν)^(−p)]√(qν/2π)exp(−qν/2) | Same (Eq. 1) | — | **Match** |
| 3.2 | A = 0.3222 | Same | — | **Match** |
| 3.3 | q = 0.707 | Same | $q=0.75$ (thesis) | **Match** |
...
| # | Claim in `.md` | Paper (Table 3, "ALL" row) | Pipeline (Pinetti 2022) | Status |
|---|----------------|---------------------------|-------------------------|--------|
...
| # | Claim in `.md` | Paper (Table 3) | Pipeline (Pinetti 2022) | Status |
|---|----------------|-----------------|-------------------------|--------|
...
| 6.10 | LDDE inverse-sum evolution form | Paper Eq. 18 uses **positive** exponents: $[r^{p_1} + r^{p_2}]^{-1}$. Pinetti Eq. C.4 uses **negative** exponents: $[r^{-p_1} + r^{-p_2}]^{-1}$. Pipeline follows Pinetti. | Negative exponents per thesis Eq. C.4 | **Exponent sign discrepancy** — pipeline follows Pinetti (2022), not original paper. Produces different evolution shape around z_c. |
...
| # | Claim in `.md` | Paper (Table 1, Model C) | Pipeline (Pinetti 2022) | Status |
|---|----------------|--------------------------|-------------------------|--------|
...
| # | Claim in `.md` | Paper (Table 8) | Pipeline (Pinetti 2022) | Status |
|---|----------------|-----------------|-------------------------|--------|
...
| 11.6 | SF-AGN: k_L=3.17, k_R1=0.67, k_R2=−3.17 | 3.17±0.04, 0.67±0.05, −3.17±0.15 | $-3.17$ (thesis typo; follows original) | **Match** (sign error fixed in docs and code) |
...
| # | Claim in `.md` | Paper (Table 5) | Pipeline (Pinetti 2022) | Status |
|---|----------------|-----------------|-------------------------|--------|
...
| # | Claim in `.md` | Paper (Table A1) | Pipeline (Pinetti 2022) | Status |
|---|----------------|------------------|-------------------------|--------|
...
| # | Claim in `.md` | Paper (Table 1, Plik column) | Pipeline (Pinetti 2022) | Status |
|---|----------------|------------------------------|-------------------------|--------|
...
| Status | Count | Pipeline (Pinetti 2022) |
|--------|-------|-------------------------|
...
| # | File | Issue | Severity | Pipeline (Pinetti 2022) | Action |
|---|------|-------|----------|-------------------------|--------|
...
| Symbol | Meaning | Pipeline (Pinetti 2022) |
|--------|---------|-------------------------|
...
| # | Claim / Parameter | Pinetti (2022) | Code (`config.py`) | Pipeline (Pinetti 2022) | Status |
|---|-------------------|----------------|---------------------|-------------------------|--------|
...
| # | Claim / Parameter | Pinetti (2022) | Code (`halo_model.py`, `hmf_interface.py`) | Pipeline (Pinetti 2022) | Status |
|---|-------------------|----------------|---------------------------------------------|-------------------------|--------|
| 2.1 | Fitting function | Sheth-Tormen (Eq. 3.33) | Sheth-Mo-Tormen via `hmf` package | — | **Match** |
| 2.2 | Parameter p | p = 0.3 (Eq. 3.33) | p = 0.3 | — | **Match** |
| 2.3 | Parameter q | **q = 0.75** (Eq. 3.33) | **q = 0.707** | $q=0.75$ (thesis) | **Differs** — Code uses the more common SMT (1999) value 0.707; thesis uses 0.75 from Sheth & Tormen (2002). Both are used in the literature. |
...
| # | Claim / Parameter | Pinetti (2022) | Code (`halo_model.py`) | Pipeline (Pinetti 2022) | Status |
|---|-------------------|----------------|------------------------|-------------------------|--------|
...
| # | Claim / Parameter | Pinetti (2022) | Code (`halo_model.py`, `dm_model.py`) | Pipeline (Pinetti 2022) | Status |
|---|-------------------|----------------|----------------------------------------|-------------------------|--------|
...
| # | Claim / Parameter | Pinetti (2022) | Code (`angular_power.py`, `dm_model.py`, `hi_model.py`) | Pipeline (Pinetti 2022) | Status |
|---|-------------------|----------------|----------------------------------------------------------|-------------------------|--------|
...
| # | Claim / Parameter | Pinetti (2022) | Code (`hi_model.py`) | Pipeline (Pinetti 2022) | Status |
|---|-------------------|----------------|----------------------|-------------------------|--------|
...
| # | Claim / Parameter | Pinetti (2022) | Code (`astro_sources.py`) | Pipeline (Pinetti 2022) | Status |
|---|-------------------|----------------|---------------------------|-------------------------|--------|
...
| # | Claim / Parameter | Pinetti (2022) | Code (`angular_power.py`) | Pipeline (Pinetti 2022) | Status |
|---|-------------------|----------------|---------------------------|-------------------------|--------|
...
| # | Claim / Parameter | Pinetti (2022) | Code (`noise_model.py`, `config.py`) | Pipeline (Pinetti 2022) | Status |
|---|-------------------|----------------|--------------------------------------|-------------------------|--------|
...
| # | Claim / Parameter | Pinetti (2022) | Code (`noise_model.py`) | Pipeline (Pinetti 2022) | Status |
|---|-------------------|----------------|-------------------------|-------------------------|--------|
...
| # | Claim / Parameter | Pinetti (2022) | Code (`statistics.py`) | Pipeline (Pinetti 2022) | Status |
|---|-------------------|----------------|------------------------|-------------------------|--------|
...
| # | Item | Nature of Difference | Pipeline (Pinetti 2022) | Impact |
|---|------|---------------------|-------------------------|--------|
| 2.3 | SMT q parameter | Code: 0.707 vs Thesis: 0.75 | $q=0.75$ (thesis) | **Low** — both are common in literature; ~5% effect on mass function tails |
...
| # | Item | Thesis Reference | Pipeline (Pinetti 2022) | Reason Not Implemented |
|---|------|-----------------|-------------------------|------------------------|
