...
\textbf{Noise-dominated approximation} (\href{https://arxiv.org/abs/1911.04989}{Pinetti} Eq.~5.5):
\begin{equation}
...
\begin{itemize}
    ...
    \item Sum over 12 Fermi energy bins (forecast) or 11 \href{https://arxiv.org/abs/1808.09225}{Ammazzalorso+2018} bins (data)
...
\textbf{$\Delta\chi^2$ test statistic} (\href{https://arxiv.org/abs/1911.04989}{Pinetti} Eq.~5.7):
\begin{equation}
